...
/**
 *class that uses the wrapper facade pattern in order to encapsulate the basics operations over sockets
 */
public class SOCStream
{
	/**
	 ...
	 */
	public SOCStream (Socket s) throws IOException
	{
		this.socket (s);
	}
